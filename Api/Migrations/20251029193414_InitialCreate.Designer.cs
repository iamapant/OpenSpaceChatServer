...
namespace Api.Migrations
{
    ...
    [Migration("20251029193414_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Database.Models.Message", b =>
                {
                    ...
                    b.Property<Guid>("MessageFontFamilyId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("MessageFontStyleId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MessageFontFamilyId");

                    b.HasIndex("MessageFontStyleId");
            ...
            modelBuilder.Entity("Api.Database.Models.ReportData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Api.Database.Models.Message", b =>
                {
                    ...
                    b.HasOne("Api.Database.Models.FontFamily", "MessageFontFamily")
                        .WithMany()
                        .HasForeignKey("MessageFontFamilyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Api.Database.Models.FontStyle", "MessageFontStyle")
                        .WithMany()
                        .HasForeignKey("MessageFontStyleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("MessageFontFamily");

                    b.Navigation("MessageFontStyle");
            ...
            modelBuilder.Entity("Api.Database.Models.PrivateMessage", b =>
                {
                    b.HasOne("Api.Database.Models.Channel", "Dm")
                        .WithMany()
                        .HasForeignKey("DmId");
